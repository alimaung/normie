...
set "INSTALLER_PATH=%~dp0install.ps1"
if not exist "%INSTALLER_PATH%" (
    echo [ERROR] installer.ps1 not found in the same directory!
    ...
    echo - installer.ps1 ^(main installer^)
    echo.
    pause
    exit /b 1
)
...
echo ============================================================
call "C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe" "%INSTALLER_PATH%"
