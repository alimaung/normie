#!/usr/bin/env python3
"""
Link Verifier (Full Version) - Verify hyperlinks against actual directory structure
This version saves ALL broken links, not just the first 100
"""
...
class LinkVerifierFull:
    ...
    def generate_report(self):
        ...
        report = {
            ...
            'all_broken_link_details': self.verification_results['broken_link_details'],  # ALL broken links
            'sample_broken_links': self.verification_results['broken_link_details'][:10]  # First 10 for quick review
        }
        
        return report
    
    def save_report(self, output_file="link_verification_report_full.json"):
    ...
    def print_summary(self):
        ...
        print("\n" + "="*60)
        print("LINK VERIFICATION SUMMARY (FULL)")
        print("="*60)
        ...
        print(f"ALL {broken + invalid:,} broken/invalid links saved to report")
...
def main():
    ...
    print("Link Verifier (Full Version) v1.0")
    print("=" * 50)
    ...
    verifier = LinkVerifierFull(excel_json, directory_index, verbose=True)
