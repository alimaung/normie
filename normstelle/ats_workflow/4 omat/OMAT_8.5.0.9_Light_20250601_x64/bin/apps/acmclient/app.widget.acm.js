...
(function () {
    ...
    angular
        .module('app.widget.acm')
        .config(function ($stateProvider, $urlRouterProvider, $urlMatcherFactoryProvider, acmConstants, $locationProvider) {
                ...
                .state('app.default', {
                    ...
                    views: {
                        'mainView@app': {
                            ...
                            controller: function($scope, acmappconfig) {
                                $scope.acmappconfig = acmappconfig;
                            }
                        }
                    },
                    resolve:{
                        acmappconfig:function(flatironsAppConfigService){
                            return flatironsAppConfigService.getAppConfig();
                        }
                    }
                })
                ...
                .state('app.configuration', {
                    ...
                    views: {
                        'leftView@app': {
                            ...
                            controller: function($scope, configuriationListPermissions){
                                $scope.configuriationListPermissions = configuriationListPermissions;
                            }
                        }
                    },
                    resolve:{
                        configuriationListPermissions:function(privilegeService){
                ...
                .state('app.configuration.ldapconfiguration', {
                    ...
                    views: {
                        'mainView@app': {
                            ...
                            controller: function($scope, authProviderConfig, ldapConfiguration, ldapConfigurationPermissions) {
                    ...
                    resolve:{
                        authProviderConfig:function(authProvService) {
                            return authProvService.retrieveAuthProvConfiguration();
                        },
                        ldapConfiguration:function(ldapService) {
                            return ldapService.retrieveLDAPConfiguration();
                        },
                        ldapConfigurationPermissions:function(privilegeService) {
                ...
                .state('app.configuration.samlconfiguration', {
                    ...
                    views: {
                        'mainView@app': {
                            ...
                            controller: function($scope, samlConfiguration, samlConfigurationPermissions) {
                    ...
                    resolve:{
                        samlConfiguration:function(samlService) {
                            return samlService.retrieveSAMLConfiguration();
                        },
                        samlConfigurationPermissions:function(privilegeService) {
