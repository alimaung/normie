...
(function(global, factory) {
	...
	Panzoom.prototype = {
		...
		/**
		 * A fix to store a matrix object
		 * @param {Array|String} matrix
		 */
		store: function() {
			var matrix = this.getMatrix(this._origTransform);
			return matrix;
		},

		/**
		 * A fix to restore a matrix object, set the current matrix of the element
		 * @param {Array|String} matrix
		 */
		restore: function(transform) {
			if(transform !== null && transform !== undefined) {
				var matrix = this.setMatrix(transform);
				//var matrix = this.getMatrix(this._origTransform);
				this._trigger('reset', matrix);
			}
		}
